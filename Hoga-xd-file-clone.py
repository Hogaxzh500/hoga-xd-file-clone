...
#            #    ######  ######    #             #
 ...
 [*]=============================================
    ...
    Facebook : https://www.facebook.com/profile.php?id=100077528239363
...
class msort:
	...
	def __init__(self):
		...
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/Hogaxd.txt')

		os.system('rm -rf /sdcard/1.txt')

		os.system('rm -rf /sdcard/xhz.txt.txt')

		os.system('rm -rf /sdcard/xhz.txt')

		print(47*'\033[1;97m-\033[0;0m')

		print ("\n[✓] Dumping and Sliced successfully ..")

		print ("[✓] Your file path : /storage/emulated/0/Hogaxd.txt")
